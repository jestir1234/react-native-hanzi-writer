...
const LOCAL_CHARACTER_SAMPLES: Record<string, any> = {
  ...
  ょ: require('../assets/kana/hiragana-12423.json'),
  る: require('../assets/kana/hiragana-12427.json'),
  // Dakuten
  が: require('../assets/kana/hiragana-12364.json'),
  ぎ: require('../assets/kana/hiragana-12366.json'),
  ぐ: require('../assets/kana/hiragana-12368.json'),
  げ: require('../assets/kana/hiragana-12370.json'),
  ご: require('../assets/kana/hiragana-12372.json'),
  ざ: require('../assets/kana/hiragana-12374.json'),
  じ: require('../assets/kana/hiragana-12376.json'),
  ず: require('../assets/kana/hiragana-12378.json'),
  ぜ: require('../assets/kana/hiragana-12380.json'),
  ぞ: require('../assets/kana/hiragana-12382.json'),
  だ: require('../assets/kana/hiragana-12384.json'),
  ぢ: require('../assets/kana/hiragana-12386.json'),
  づ: require('../assets/kana/hiragana-12389.json'),
  で: require('../assets/kana/hiragana-12391.json'),
  ど: require('../assets/kana/hiragana-12393.json'),
  ば: require('../assets/kana/hiragana-12400.json'),
  び: require('../assets/kana/hiragana-12403.json'),
  ぶ: require('../assets/kana/hiragana-12406.json'),
  べ: require('../assets/kana/hiragana-12409.json'),
  ぼ: require('../assets/kana/hiragana-12412.json'),
  // Handakuten
  ぱ: require('../assets/kana/hiragana-12401.json'),
  ぴ: require('../assets/kana/hiragana-12404.json'),
  ぷ: require('../assets/kana/hiragana-12407.json'),
  ぺ: require('../assets/kana/hiragana-12410.json'),
  ぽ: require('../assets/kana/hiragana-12413.json'),
};
